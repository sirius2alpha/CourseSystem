...
public class CourseController {
    ...
    public Result teacherCourseList(@PathVariable("teacherId") Integer teacherId) {
        ...
        return Result.suc(result, Long.parseLong(String.valueOf(result.size())));
    }
    ...
    private void getCourseExtInfo(Course course) {
        ...
        wrapper.eq(SelectedCourses::getCurrentCourseId, courseId);
        int count = selectedCoursesService.count(wrapper);
